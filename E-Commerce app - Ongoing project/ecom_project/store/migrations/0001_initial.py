# Generated by Django 5.2.7 on 2025-10-07 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('vendor', 'Vendor'), ('shopper', 'Shopper')], default='shopper', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shopper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
